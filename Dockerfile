...
ENTRYPOINT ["java","-Duser.name=EDUC_GRAD_RULE_ENGINE_API","-Xms512m","-Xmx512m","-noverify","-XX:TieredStopAtLevel=1",\
            ...
            "ca.bc.gov.educ.api.ruleengine.EducRuleEngineApiApplication"]
